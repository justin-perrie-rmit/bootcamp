    ...
    handleLoginMessage: function(messageObject)
    {
        ...
        else
        {
            alert(`
                ...
                You may have already logged in today; if so, please come back tomorrow.
                Otherwise the game code you entered is not valid or has expired.
                Please check your code and try again.
                
                Tip: Make sure there are no extra spaces before or after the code.
                Further issues, please contact Justin at justin.perrie@rmit.edu.au.
                `
            );
        }
    },
